...
void ExtractReceivedGeneratorFields(GWEN_BUFFER * mbuf, int* ATC, char *TAN_String, uint32_t maxTanLen, char* pCardnummber, char* pEndDate, char* pIssueDate) {
...
/* Read information from Card
   ...
   pIssueDate:       pointer to IssueDate of card ddmmyy 
                          (char[7])  4 +  Terminator
*/
int GetTanfromUSB_Generator(unsigned char* HHDCommand, int fullHHD_Len, int* pATC, char* pGeneratedTAN, uint32_t maxTanLen, char* pCardnummber, char* pEndDate, char* pIssueDate) {
