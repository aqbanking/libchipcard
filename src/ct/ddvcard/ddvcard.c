...
CHIPCARD_EXPORT GWEN_PLUGIN *ct_ddvcard_factory(GWEN_PLUGIN_MANAGER *pm,
                                                const char *modName,
                                                const char *fileName)
{
  GWEN_PLUGIN *pl;
...
GWEN_CRYPT_TOKEN *GWENHYWFAR_CB LC_Crypt_TokenDDV_Plugin_CreateToken(GWEN_PLUGIN *pl,
                                                                     const char *name)
{
...
int GWENHYWFAR_CB LC_Crypt_TokenDDV_Plugin_CheckToken(GWEN_PLUGIN *pl,
                                                      GWEN_BUFFER *name)
{
  GWEN_PLUGIN_MANAGER *pm;
  LC_CT_PLUGIN_DDV *cpl;
...
int GWENHYWFAR_CB LC_Crypt_TokenDDV_Open(GWEN_CRYPT_TOKEN *ct, int manage, uint32_t guiid)
{
  LC_CT_DDV *lct;
  int rv;
  int i;
...
int GWENHYWFAR_CB LC_Crypt_TokenDDV_Close(GWEN_CRYPT_TOKEN *ct,
                                          int abandon,
                                          uint32_t guiid)
{
  LC_CT_DDV *lct;
...
int GWENHYWFAR_CB LC_Crypt_TokenDDV_GetKeyIdList(GWEN_CRYPT_TOKEN *ct,
                                                 uint32_t *pIdList,
                                                 uint32_t *pCount,
                                                 uint32_t gid)
{
...
const GWEN_CRYPT_TOKEN_KEYINFO *GWENHYWFAR_CB LC_Crypt_TokenDDV_GetKeyInfo(GWEN_CRYPT_TOKEN *ct,
                                                                           uint32_t id,
                                                                           uint32_t flags,
                                                                           uint32_t gid)
{
...
int GWENHYWFAR_CB LC_Crypt_TokenDDV_SetKeyInfo(GWEN_CRYPT_TOKEN *ct,
                                               uint32_t id,
...
int GWENHYWFAR_CB LC_Crypt_TokenDDV_GetContextIdList(GWEN_CRYPT_TOKEN *ct,
                                                     uint32_t *pIdList,
                                                     uint32_t *pCount,
                                                     uint32_t gid)
{
...
const GWEN_CRYPT_TOKEN_CONTEXT *GWENHYWFAR_CB LC_Crypt_TokenDDV_GetContext(GWEN_CRYPT_TOKEN *ct,
                                                                           uint32_t id,
                                                                           uint32_t gid)
{
  LC_CT_DDV *lct;
...
int GWENHYWFAR_CB LC_Crypt_TokenDDV_SetContext(GWEN_CRYPT_TOKEN *ct,
                                               uint32_t id,
...
int GWENHYWFAR_CB LC_Crypt_TokenDDV_Sign(GWEN_CRYPT_TOKEN *ct,
                                         uint32_t keyId,
...
int GWENHYWFAR_CB LC_Crypt_TokenDDV_Verify(GWEN_CRYPT_TOKEN *ct,
                                           uint32_t keyId,
                                           GWEN_CRYPT_PADDALGO *a,
                                           const uint8_t *pInData,
                                           uint32_t inLen,
...
int GWENHYWFAR_CB LC_Crypt_TokenDDV_Encipher(GWEN_CRYPT_TOKEN *ct,
                                             uint32_t keyId,
                                             GWEN_CRYPT_PADDALGO *a,
                                             const uint8_t *pInData,
                                             uint32_t inLen,
...
int GWENHYWFAR_CB LC_Crypt_TokenDDV_Decipher(GWEN_CRYPT_TOKEN *ct,
                                             uint32_t keyId,
                                             GWEN_CRYPT_PADDALGO *a,
                                             const uint8_t *pInData,
                                             uint32_t inLen,
