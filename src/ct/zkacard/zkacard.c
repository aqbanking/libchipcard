...
GWEN_CRYPT_TOKEN *GWENHYWFAR_CB LC_Crypt_TokenZka_Plugin_CreateToken(GWEN_PLUGIN *pl,
                                                                     const char *name)
{
...
int GWENHYWFAR_CB LC_Crypt_TokenZka_Plugin_CheckToken(GWEN_PLUGIN *pl,
                                                      GWEN_BUFFER *name)
{
  GWEN_PLUGIN_MANAGER *pm;
  LC_CT_PLUGIN_ZKA *cpl;
...
int GWENHYWFAR_CB LC_Crypt_TokenZka_Encipher(GWEN_CRYPT_TOKEN *ct,
                                             ...
                                             uint32_t gid)
{
  DBG_INFO(LC_LOGDOMAIN, "LC_Crypt_TokenZka_Encipher called with kid=%d (%s)!", kid,
           GWEN_Crypt_PaddAlgoId_toString(GWEN_Crypt_PaddAlgo_GetId(a)));
  return GWEN_ERROR_NOT_IMPLEMENTED;
}
