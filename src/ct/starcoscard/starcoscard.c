...
CHIPCARD_EXPORT GWEN_PLUGIN *ct_starcoscard_factory(GWEN_PLUGIN_MANAGER *pm,
                                                    const char *modName,
                                                    const char *fileName)
{
  GWEN_PLUGIN *pl;
...
GWEN_CRYPT_TOKEN *GWENHYWFAR_CB LC_Crypt_TokenStarcos_Plugin_CreateToken(GWEN_PLUGIN *pl,
                                                                         const char *name)
{
...
int GWENHYWFAR_CB LC_Crypt_TokenStarcos_Plugin_CheckToken(GWEN_PLUGIN *pl,
                                                          GWEN_BUFFER *name)
{
  GWEN_PLUGIN_MANAGER *pm;
  LC_CT_PLUGIN_STARCOS *cpl;
...
int GWENHYWFAR_CB LC_Crypt_TokenStarcos_Open(GWEN_CRYPT_TOKEN *ct, int manage, uint32_t guiid)
{
  LC_CT_STARCOS *lct;
  int rv;
  int i;
...
int GWENHYWFAR_CB LC_Crypt_TokenStarcos_Close(GWEN_CRYPT_TOKEN *ct,
                                              int abandon,
                                              uint32_t guiid)
{
  LC_CT_STARCOS *lct;
...
int GWENHYWFAR_CB LC_Crypt_TokenStarcos_GetKeyIdList(GWEN_CRYPT_TOKEN *ct,
                                                     uint32_t *pIdList,
                                                     uint32_t *pCount,
                                                     uint32_t gid)
{
...
const GWEN_CRYPT_TOKEN_KEYINFO *GWENHYWFAR_CB LC_Crypt_TokenStarcos_GetKeyInfo(GWEN_CRYPT_TOKEN *ct,
                                                                               uint32_t kid,
                                                                               uint32_t flags,
                                                                               uint32_t gid)
{
...
int GWENHYWFAR_CB LC_Crypt_TokenStarcos_SetKeyInfo(GWEN_CRYPT_TOKEN *ct,
                                                   uint32_t kid,
...
int GWENHYWFAR_CB LC_Crypt_TokenStarcos_GetContextIdList(GWEN_CRYPT_TOKEN *ct,
                                                         uint32_t *pIdList,
                                                         uint32_t *pCount,
                                                         uint32_t gid)
{
...
const GWEN_CRYPT_TOKEN_CONTEXT *GWENHYWFAR_CB LC_Crypt_TokenStarcos_GetContext(GWEN_CRYPT_TOKEN *ct,
                                                                               uint32_t id,
                                                                               uint32_t gid)
{
  LC_CT_STARCOS *lct;
...
int GWENHYWFAR_CB LC_Crypt_TokenStarcos_SetContext(GWEN_CRYPT_TOKEN *ct,
                                                   uint32_t id,
...
int GWENHYWFAR_CB LC_Crypt_TokenStarcos_GenerateKey(GWEN_CRYPT_TOKEN *ct,
                                                    uint32_t kid,
...
int GWENHYWFAR_CB LC_Crypt_TokenStarcos_Sign(GWEN_CRYPT_TOKEN *ct,
                                             uint32_t kid,
...
int GWENHYWFAR_CB LC_Crypt_TokenStarcos_Verify(GWEN_CRYPT_TOKEN *ct,
                                               uint32_t kid,
                                               GWEN_CRYPT_PADDALGO *a,
                                               const uint8_t *pInData,
                                               uint32_t inLen,
...
int GWENHYWFAR_CB LC_Crypt_TokenStarcos_Encipher(GWEN_CRYPT_TOKEN *ct,
                                                 uint32_t kid,
                                                 GWEN_CRYPT_PADDALGO *a,
                                                 const uint8_t *pInData,
                                                 uint32_t inLen,
...
int GWENHYWFAR_CB LC_Crypt_TokenStarcos_Decipher(GWEN_CRYPT_TOKEN *ct,
                                                 uint32_t kid,
                                                 GWEN_CRYPT_PADDALGO *a,
                                                 const uint8_t *pInData,
                                                 uint32_t inLen,
