...
typedef int CHIPCARD_CB(*LC_CARD_GETPINSTATUS_FN)(LC_CARD *card,
                                                  unsigned int pid,
                                                  int *maxErrors,
                                                  int *currentErrors);

typedef int CHIPCARD_CB(*LC_CARD_GETINITIALPIN_FN)(LC_CARD *card,
                                                   int id,
...
typedef int CHIPCARD_CB(*LC_CARD_ISOREADBINARY_FN)(LC_CARD *card,
                                                   uint32_t flags,
                                                   int offset,
                                                   int size,
                                                   GWEN_BUFFER *buf);

typedef int CHIPCARD_CB(*LC_CARD_ISOWRITEBINARY_FN)(LC_CARD *card,
                                                    uint32_t flags,
                                                    int offset,
                                                    const char *ptr,
                                                    unsigned int size);
...
typedef int CHIPCARD_CB(*LC_CARD_ISOUPDATEBINARY_FN)(LC_CARD *card,
                                                     uint32_t flags,
                                                     int offset,
                                                     const char *ptr,
                                                     unsigned int size);

typedef int CHIPCARD_CB(*LC_CARD_ISOERASEBINARY_FN)(LC_CARD *card,
                                                    uint32_t flags,
                                                    int offset,
                                                    unsigned int size);

typedef int CHIPCARD_CB(*LC_CARD_ISOREADRECORD_FN)(LC_CARD *card,
                                                   uint32_t flags,
                                                   int recNum,
                                                   GWEN_BUFFER *buf);

typedef int CHIPCARD_CB(*LC_CARD_ISOWRITERECORD_FN)(LC_CARD *card,
                                                    uint32_t flags,
                                                    int recNum,
                                                    const char *ptr,
                                                    unsigned int size);

typedef int CHIPCARD_CB(*LC_CARD_ISOAPPENDRECORD_FN)(LC_CARD *card,
                                                     uint32_t flags,
                                                     const char *ptr,
                                                     unsigned int size);

typedef int CHIPCARD_CB(*LC_CARD_ISOUPDATERECORD_FN)(LC_CARD *card,
                                                     uint32_t flags,
                                                     int recNum,
                                                     const char *ptr,
                                                     unsigned int size);

typedef int CHIPCARD_CB(*LC_CARD_ISOVERIFYPIN_FN)(LC_CARD *card,
                                                  uint32_t flags,
                                                  const LC_PININFO *pi,
...
typedef int CHIPCARD_CB(*LC_CARD_ISOMODIFYPIN_FN)(LC_CARD *card,
                                                  uint32_t flags,
                                                  const LC_PININFO *pi,
...
typedef int CHIPCARD_CB(*LC_CARD_ISOPERFORMVERIFICATION_FN)(LC_CARD *card,
                                                            uint32_t flags,
                                                            const LC_PININFO *pi,
                                                            int *triesLeft);

typedef int CHIPCARD_CB(*LC_CARD_ISOPERFORMMODIFICATION_FN)(LC_CARD *card,
                                                            uint32_t flags,
                                                            const LC_PININFO *pi,
                                                            int *triesLeft);


typedef int CHIPCARD_CB(*LC_CARD_ISOMANAGESE_FN)(LC_CARD *card,
                                                 int tmpl,
                                                 int kids, int kidp,
                                                 int ar);

typedef int CHIPCARD_CB(*LC_CARD_ISOSIGN_FN)(LC_CARD *card,
                                             const char *ptr,
                                             unsigned int size,
                                             GWEN_BUFFER *sigBuf);

typedef int CHIPCARD_CB(*LC_CARD_ISOVERIFY_FN)(LC_CARD *card,
                                               const char *dptr,
                                               unsigned int dsize,
                                               const char *sigptr,
                                               unsigned int sigsize);

typedef int CHIPCARD_CB(*LC_CARD_ISOENCIPHER_FN)(LC_CARD *card,
                                                 const char *ptr,
                                                 unsigned int size,
                                                 GWEN_BUFFER *codeBuf);

typedef int CHIPCARD_CB(*LC_CARD_ISODECIPHER_FN)(LC_CARD *card,
                                                 const char *ptr,
                                                 unsigned int size,
                                                 GWEN_BUFFER *codeBuf);

typedef int CHIPCARD_CB(*LC_CARD_ISOINTERNALAUTH_FN)(LC_CARD *card,
                                                     int kid,
                                                     const unsigned char *ptr,
                                                     unsigned int size,
                                                     GWEN_BUFFER *rBuf);
